...
\begin{definition}
  ...
  \end{equation}
\end{definition}
So the first part of duality theory concerns the existence of this dualising sheaf. A sufficient condition is that~$X$ is projective \cite[proposition III.7.5]{hartshorne-algebraic-geometry}. In later seminars more general existence conditions will be discussed. One can prove that such a dualising sheaf and trace morphism are unique if they exist \cite[proposition III.7.2]{hartshorne-algebraic-geometry}.

The next part concerns the actual duality. We state \cite[proposition 7.6]{hartshorne-algebraic-geometry}.
\begin{theorem}[Serre duality]
  \label{theorem:serre-duality}
  Let~$X/k$ be a projective~$n$\dash dimensional scheme. Let~$\omega_X^\circ$ be its dualising sheaf. Let~$\mathcal{O}(1)$ be a very ample sheaf on~$X$. Then for all~$i\geq 0$ and~$\mathcal{F}\in\Coh/X$ we have functorial maps
  \begin{equation}
...
\begin{enumerate}
  \item Prove Serre duality for~$\mathbb{P}_k^n$, which is very concrete. The dualizing sheaf~$\omega_{\mathbb{P}_k^n}=\bigwedge^n\Omega_{\mathbb{P}_k^n/k}$ is~$\mathcal{O}_{\mathbb{P}_k^n}(-n-1)$.
...
This yields the following pictures
\begin{table}
  \centering
  \input{n-1}
  \caption{Dimensions of~$\HH^i(\mathbb{P}_k^1,\mathcal{O}_{\mathbb{P}_k^1}(r))$}
  \label{table:dimensions-projective-line}
\end{table}

\begin{table}
  \centering
  \input{n-2}
  \caption{Dimensions of~$\HH^i(\mathbb{P}_k^2,\mathcal{O}_{\mathbb{P}_k^2}(r))$}
  \label{table:dimensions-projective-line}
\end{table}
...
\begin{table}
  \centering
  \input{n-3}
  \caption{Dimensions of~$\HH^i(\mathbb{P}_k^3,\mathcal{O}_{\mathbb{P}_k^3}(r))$}
  \label{table:dimensions-projective-line}
\end{table}
...
\begin{table}
  \centering
  \input{n-4}
  \caption{Dimensions of~$\HH^i(\mathbb{P}_k^4,\mathcal{O}_{\mathbb{P}_k^4}(r))$}
  \label{table:dimensions-projective-line}
\end{table}
